    ...
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        with tf.device('/cpu:0'), tf.name_scope("embedding"):
            ...
            # TensorFlow’s convolutional conv2d operation expects a 4-dimensional input tensor (and also filter tensor)
            ...
            # so we add it manually using expand_dims, giving us a layer of shape [None, sequence_length, embedding_size, 1]
        ...
        with tf.name_scope("loss"):
        	...
        	# weighted_logits = tf.multiply(self.scores, class_weight)
        	# losses = tf.nn.softmax_cross_entropy_with_logits(logits=weighted_logits, labels=self.input_y)
